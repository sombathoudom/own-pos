...
import { index as customersIndex, store as customersStore } from '@/routes/customers';
    ...
    return (
        <>
            ...
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Add Customer" pageTitle="Customers" />
...
CustomersCreate.layout = (page: ReactNode) => <Layout>{page}</Layout>;
