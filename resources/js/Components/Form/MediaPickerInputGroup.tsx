    ...
    <>
          ...
          >
            {hasPreview ? (
              <img
                src={previewUrl!}
                alt="Selected"
                style={{ height: "100%", width: "auto", borderRadius: 6 }}
              />
            ) : (
              <span className="text-muted small">{helperText}</span>
            )}
          </div>
      ...
      <MediaPickerModal
        ...
        onPicked={(items) => {
          ...
          const preview = first.thumbnail || first.url || first.external_url || null;
