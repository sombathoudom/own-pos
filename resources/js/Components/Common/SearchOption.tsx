                ...
                >
                    <SimpleBar style={{ height: '320px' }}>
                        <div className="dropdown-header">
                            <h6 className="text-overflow text-uppercase mb-0 text-muted">
                                Recent Searches
                            </h6>
                        </div>
                                ...
                                {!menuItem.subItems ? (
                                    ...
                                    >
                                        <i
                                            className={
                                                menuItem.icon +
                                                ' fs-xl me-2 align-middle text-muted'
                                            }
                                        ></i>
                                    ...
                                    <div className="dropdown-header mt-2">
                                        <h6 className="text-overflow text-uppercase mb-1 text-muted">
                                            {menuItem.label}
                                        </h6>
                                    </div>
                                )}
                        ...
                        <div className="dropdown-header mt-2">
                            <h6 className="text-overflow text-uppercase mb-2 text-muted">
                                Members
                            </h6>
                        </div>
