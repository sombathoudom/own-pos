...
const TableContainer = ({
    ...
    return (
        <Fragment>
            {isGlobalFilter && (
                <Row className="mb-3">
                    <Card.Body className="border-end-0 border-start-0 border border-dashed">
                        <form>
                            <Row>
                                <Col sm={5}>
                                    <div
                                        className={
                                            ...
                                            isCompaniesFilter ||
                                            isNFTRankingFilter
                                                ? 'search-box d-inline-block me-2 mb-2'
                                                : 'search-box d-inline-block col-12 me-2 mb-2'
                                        }
                                    >
                                        <DebouncedInput
                                            value={globalFilter ?? ''}
            ...
            <Row className="align-items-center g-3 text-sm-start mt-2 text-center">
