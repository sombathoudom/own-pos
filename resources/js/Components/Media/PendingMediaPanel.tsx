...
export default function PendingMediaPanel({
    ...
    useEffect(() => {
        const run = async () => {
            ...
            setItems(
                ids.map((id) => map.get(id)).filter(Boolean) as MediaItem[],
            );
        };
                ...
                <div className="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div className="d-flex gap-2">
                        {sortable && ids.length > 1 && (
                            <div className="small align-self-center text-muted">
                                        ...
                                        <div className="rounded border p-2">
                                            ...
                                            >
                                                {thumb(m) ? (
                                                    ...
                                                    <div className="d-flex align-items-center justify-content-center small h-100 text-muted">
                                                        Media
                                                    </div>
                                                )}
                                            </div>
